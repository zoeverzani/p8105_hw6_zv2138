...
![](p8105_hw6_zv2138_files/figure-gfm/unnamed-chunk-3-1.png)<!-- --> We
can see from the above plots the distribution of the R-squared Estimate
and the distribution of the Estimated Log of b0*b1 follow a normal
distribution. The Estimated Log of b0*b1 distribution has a center
around 2.01. The R-squared Estimate distribution has a center around
0.91.
...
The 95% confidence interval for *r̂*<sup>2</sup> is 0.8941081 to
0.9272026

The 95% confidence interval for log (*β̂*<sub>0</sub> \* *β̂*<sub>1</sub>)
is 1.9656473 to 2.0592239
